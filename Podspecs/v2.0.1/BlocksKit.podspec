Pod::Spec.new do |s|
  s.name                  = 'BlocksKit-cop'
  s.version               = '2.0.1'
  s.license               = 'MIT'
  s.summary               = 'The Objective-C block utilities you always wish you had.'
  s.homepage              = 'https://github.com/Coppertino/BlocksKit'
  s.author                = { 'Zachary Waldowski' => 'zach@waldowski.me',
                              'Alexsander Akers'  => 'a2@pnd.mn' }
  s.source                = { :git => 'https://github.com/Coppertino/BlocksKit.git', :branch => "lion-compatible", :tag => "v#{s.version}" }
  s.requires_arc          = true
